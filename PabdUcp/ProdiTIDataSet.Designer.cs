...
namespace PabdUcp {
    ...
    public partial class ProdiTIDataSet : global::System.Data.DataSet {
        ...
        public partial class MahasiswaDataTable : global::System.Data.TypedTableBase<MahasiswaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public MahasiswaRow AddMahasiswaRow(string NIM, string Nama, string Angkatan, string Alamat, string NoHp) {
            ...
            private void InitClass() {
                ...
                this.columnAngkatan.MaxLength = 50;
...
namespace PabdUcp.ProdiTIDataSetTableAdapters {
    ...
    public partial class MahasiswaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Mahasiswa] WHERE (([NIM] = @Original_NIM) AND ((@IsNull_Nama = 1 AND [Nama] IS NULL) OR ([Nama] = @Original_Nama)) AND ((@IsNull_Angkatan = 1 AND [Angkatan] IS NULL) OR ([Angkatan] = @Original_Angkatan)) AND ((@IsNull_Alamat = 1 AND [Alamat] IS NULL) OR ([Alamat] = @Original_Alamat)) AND ((@IsNull_NoHp = 1 AND [NoHp] IS NULL) OR ([NoHp] = @Original_NoHp)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Mahasiswa] ([NIM], [Nama], [Angkatan], [Alamat], [NoHp]) VALUE" +
                "S (@NIM, @Nama, @Angkatan, @Alamat, @NoHp);\r\nSELECT NIM, Nama, Angkatan, Alamat," +
                " NoHp FROM Mahasiswa WHERE (NIM = @NIM)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Mahasiswa] SET [NIM] = @NIM, [Nama] = @Nama, [Angkatan] = @Angkatan, [Alamat] = @Alamat, [NoHp] = @NoHp WHERE (([NIM] = @Original_NIM) AND ((@IsNull_Nama = 1 AND [Nama] IS NULL) OR ([Nama] = @Original_Nama)) AND ((@IsNull_Angkatan = 1 AND [Angkatan] IS NULL) OR ([Angkatan] = @Original_Angkatan)) AND ((@IsNull_Alamat = 1 AND [Alamat] IS NULL) OR ([Alamat] = @Original_Alamat)) AND ((@IsNull_NoHp = 1 AND [NoHp] IS NULL) OR ([NoHp] = @Original_NoHp)));
SELECT NIM, Nama, Angkatan, Alamat, NoHp FROM Mahasiswa WHERE (NIM = @NIM)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PabdUcp.Properties.Settings.Default.ProdiTIConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT NIM, Nama, Angkatan, Alamat, NoHp FROM dbo.Mahasiswa";
        ...
        public virtual int Delete(string Original_NIM, string Original_Nama, string Original_Angkatan, string Original_Alamat, string Original_NoHp) {
        ...
        public virtual int Insert(string NIM, string Nama, string Angkatan, string Alamat, string NoHp) {
            if ((NIM == null)) {
        ...
        public virtual int Update(string NIM, string Nama, string Angkatan, string Alamat, string NoHp, string Original_NIM, string Original_Nama, string Original_Angkatan, string Original_Alamat, string Original_NoHp) {
            if ((NIM == null)) {
                throw new global::System.ArgumentNullException("NIM");
            }
            else {
            ...
            if ((Original_Angkatan == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_Angkatan));
            }
            if ((Original_Alamat == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nama, string Angkatan, string Alamat, string NoHp, string Original_NIM, string Original_Nama, string Original_Angkatan, string Original_Alamat, string Original_NoHp) {
            return this.Update(Original_NIM, Nama, Angkatan, Alamat, NoHp, Original_NIM, Original_Nama, Original_Angkatan, Original_Alamat, Original_NoHp);
        }
    }
